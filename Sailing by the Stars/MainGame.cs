    ...
    public class MainGame : Microsoft.Xna.Framework.Game
    {
        ...
        // later we can change it so that different files are for different levels
        {
            ...
            catch (Exception) // when there is no path specified or the file doesn't exist, create a new game file "InitGame"
            {
                ...
                string p10 = "0,2,1000,1500,";
                string p11 = "0,4,1000,1500,";
             ...
             // THE X
               p2+"24000,-1000,0,0",p2+"30000,1500,0,0",p2+"36000,4000,0,0",p2+"42000,6500,0,0",
               p5+"24000,6500,0,0",p5+"30000,4000,0,0",p5+"36000,1500,0,0",p5+"42000,-1000,0,0",
               p2+"24000,-12500,0,0",p2+"30000,-10000,0,0",p2+"36000,-7500,0,0",p2+"42000,-5000,0,0",
               p5+"24000,-5000,0,0",p5+"30000,-7500,0,0",p5+"36000,-10000,0,0",p5+"42000,-12500,0,0",
               p2+"24000,10500,0,0",p2+"30000,13000,0,0",p2+"36000,15500,0,0",p2+"42000,17000,0,0",
               p5+"24000,17000,0,0",p5+"30000,15500,0,0",p5+"36000,13000,0,0",p5+"42000,10500,0,0",
               //Ring Planets
                ...
                p1+"47000,-6500,0,0", p1+"47000,-7500,0,0", p1+"47000,-8500,0,0", p1+"47000,-9500,0,0",
                 ...
                 //the passage
                 p11+"50000,-10000,0,0",p11+"50000,10000,0,0",p11+"50000,0,0,0",p11+"53000,-7000,0,0",p11+"53000,7000,0,0",
                 p11+"58000,0,0,0",p11+"58000,-7000,0,0",p11+"54000,0,0,0",p11+"58000,7000,0,0",
                 p11+"62000,-7000,0,0",p11+"62000,0,0,0",p11+"62000,7000,0,0",
                 p11+"65000,-4000,0,0",p11+"65000,4000,0,0",p11+"69000,-4000,0,0",p11+"69000,4000,0,0",
                 p10+"73000,0,0,0",
                //Enemy ships
