...
namespace Sailing_by_the_Stars
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            allGravObjects[2] = new Planet(150, 125, new Vector2(3550, 350));
            allGravObjects[3] = new Planet(150, 125, new Vector2(5550, 350));
            allGravObjects[4] = new Planet(150, 125, new Vector2(7550, 350));
            allGravObjects[5] = new Planet(150, 125, new Vector2(9550, 350));
            allGravObjects[6] = new Planet(150, 125, new Vector2(11550, 350));
            for (int i = 0; i < 7; i++)
            {
                int val = i + 1;
            ...
            allGravObjects[allGravObjects.Length - 1] = new Ship(100, 38, new Vector2(-1200, -500), initialVelocity); //increased the radius for the ship from 5 to 38 so it's easier to click for the demo
