//Alishan Hassan, Qian Xiong, Andrew Lee
...
namespace Sailing_by_the_Stars
{
    ...
    public class MainGame : Microsoft.Xna.Framework.Game
    {
        ...
        HUD hud;
        Boolean hudOn = true;
        public enum GameState { TitleScreen, MainMenu, InGamePlay, InGamePause, GameWin, GameLoseDeepSpace, GameLoseNoHP, Story, Controls, ControlsPause };
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            else if (gameState == GameState.ControlsPause)
            {
                g.drawControls();
            }
