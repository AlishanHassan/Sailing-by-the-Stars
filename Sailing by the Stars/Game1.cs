...
namespace Sailing_by_the_Stars
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            allGravObjects[4] = new Ship(100, 75, new Vector2(0, 360), initialVelocity); //increased the radius for the ship from 5 to 38 so it's easier to click for the demo
